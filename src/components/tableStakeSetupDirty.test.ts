...
describe('tableStakeSetupDirty', () => {
  it('is not dirty on initial open', () => {
    ...
    const current = collectTableStakeSetupSnapshot({
      gameState,
      setupStage: baseline.setupStage,
      setupTab: baseline.setupTab,
      tableMode: baseline.tableMode,
      stake: baseline.stake,
      tableName: baseline.tableName,
      invitedEmails: baseline.invitedEmails,
      invitedPlayers: baseline.invitedPlayers,
      inviteEmailInput: baseline.inviteEmailInput,
      challengeBank: baseline.challengeBank,
      seatChips: baseline.seatChips,
      bankChips: baseline.bankChips,
      bankChipsCustom: baseline.bankChipsCustom,
      bankerMode: baseline.bankerMode,
      bankerName: baseline.bankerName,
      protocolId: baseline.protocolId,
      zilchMode: baseline.zilchMode,
      targetPoints: baseline.targetPoints,
      roundLimit: baseline.roundLimit,
      diceAnimMode: baseline.diceAnimMode,
      diceAnimMs: baseline.diceAnimMs,
      diceAnimMin: baseline.diceAnimMin,
      diceAnimMax: baseline.diceAnimMax,
      advancedOpen: baseline.advancedOpen,
      ...
      inviteNote: baseline.inviteNote,
    });
