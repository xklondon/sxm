...
import { applyTableStakeSetup, } from './tableSetup';
...
export function beginTableResetSetup(state) {
    return {
...
function clearGameStateForReset(state) {
...
function appendTableResetLedgerNote(state, resetByPersonId) {
    const anchorId = resetByPersonId ??
...
function allocateRemainingSeatBankrolls(state) {
    let next = state;
 ...
 */
export function applyTableResetSetup(state, input, resetByPersonId = null) {
