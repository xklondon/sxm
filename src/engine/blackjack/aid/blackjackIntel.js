 ...
 */
export const HARD_HAND_STRATEGY = [
...
export const SOFT_HAND_STRATEGY = [
...
export const DEALER_UPCARD_STRENGTH = [
...
export const HILO_COUNT_BASICS = [
...
export const PROBABILITY_NOTES = [
...
export function findIntelByTopic(topicIncludes) {
    const all = [
        ...HARD_HAND_STRATEGY,
        ...SOFT_HAND_STRATEGY,
        ...PAIR_STRATEGY,
