...
describe('round result summary — one line per resolved box + bank header', () => {
  function settledThreeBoxTable(): GameState {
    ...
    const round = {
      ...
      outcomes: { [k1]: 'loss' as const, [k3]: 'loss' as const, [k4]: 'win' as const },
      resultMessages: {},
    };
...
describe('bank bankruptcy ends the game', () => {
  function bankBustState(): GameState {
