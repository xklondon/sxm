...
export function createBlackjackShoe(deckCount: number, deckId?: string): Deck {
  if (deckCount < 1) {
...
export function shuffleBlackjackShoe(
  shoe: Deck,
  seed?: string | number,
): Deck {
...
export function getShoeDeckCount(shoe: Deck): number {
